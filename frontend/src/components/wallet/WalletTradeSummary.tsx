      ...
      <Card>
        ...
        <CardContent className="mt-4">
          <p className="mb-4 text-sm text-muted">
            No resolved-market metrics available yet. Showing raw trade
            activity.
          </p>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <div className="text-sm text-muted">Markets Traded</div>
              <div className="mt-1 text-2xl font-bold">
            ...
            <div>
              <div className="text-sm text-muted">Avg Price</div>
              <div className="mt-1 text-2xl font-bold">
